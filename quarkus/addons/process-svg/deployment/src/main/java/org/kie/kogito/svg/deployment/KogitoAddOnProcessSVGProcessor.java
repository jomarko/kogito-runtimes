...
import static org.kie.kogito.svg.AbstractProcessSvgService.MPF_RELATIVE_PATH;
...
class KogitoAddOnProcessSVGProcessor {
    ...
    public void nativeResources(BuildProducer<NativeImageResourceBuildItem> resource, BuildProducer<NativeImageResourcePatternsBuildItem> resourcePatterns) {
        resourcePatterns.produce(NativeImageResourcePatternsBuildItem.builder().includeGlob(SVG_RELATIVE_PATH + "*.svg").includeGlob(MPF_RELATIVE_PATH + "*.mpf").build());
    }
